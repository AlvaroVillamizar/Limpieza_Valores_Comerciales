...
class DataProcessing:
    ...
    def cleaning_municipio(self, df, error_indices):
    ...
    def cleaning_antiguedad(self, df, error_indices):
        for index, row in df.iterrows():
            try:
    ...
    def metros_cuadrados(self, df, error_indices):
        for index, row in df.iterrows():
            try:
    ...
    def fill_baños(self, df, error_indices):
        for index, row in df.iterrows():
            try:
    ...
    def fill_inmueble(self, df, error_indices):
    ...
    def fill_habitaciones(self, df, error_indices):
    ...
    def fill_estrato(self, df, error_indices):
    ...
    def fill_estado_inmueble(self, df, error_indices):
        for index, row in df.iterrows():
            try:
    ...
    def fill_registro(self, df, error_indices):
        for index, row in df.iterrows():
            try:
    ...
    def fill_no_closet(self, df, error_indices):
        for index, row in df.iterrows():
            try:
